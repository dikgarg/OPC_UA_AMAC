...
The code can't be run on its own, and needs to communicate with a software (proprietery code belonging to ATLAS collaboration) specifically designed to convert the optical signals from AMACv2 chip to digital data that can be then interpreted by the above code.  
